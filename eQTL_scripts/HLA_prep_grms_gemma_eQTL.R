...
clean_grm <- function(grm_raw, females_pheno, males_pheno, write_loc, filter_write_loc, grm_type, treatment){
  ...
  write.table(females_grm, file = paste(write_loc, "HLA.females.", grm_type, ".", treatment, ".new.gemma.grm", sep = ""), sep = "\t", row.names = FALSE, col.names = FALSE, quote = FALSE)
  write.table(males_grm, file = paste(write_loc, "HLA.males.", grm_type, ".", treatment, ".new.gemma.grm", sep = ""), sep = "\t", row.names = FALSE, col.names = FALSE, quote = FALSE)
  ...
  write.table(females_id, file = paste(filter_write_loc, "HLA.females.", grm_type, ".", treatment, ".iids.txt", sep = ""), sep = "\t", row.names = FALSE, col.names = FALSE, quote = FALSE)
  write.table(males_id, file = paste(filter_write_loc, "HLA.males.", grm_type, ".", treatment , ".iids.txt", sep = ""), sep = "\t", row.names = FALSE, col.names = FALSE, quote = FALSE)
...
females_filter <- read.table(paste(filter_dir, "HLA.females.iids.txt", sep = ""), sep = "\t", header = FALSE, stringsAsFactors = FALSE)
males_filter <- read.table(paste(filter_dir, "HLA.males.iids.txt", sep = ""), sep = "\t", header = FALSE, stringsAsFactors = FALSE)
...
for (treatment in treatments) {
  ...
  #Read in filters
  auto_grm_ids_females <- read.table(paste(filter_dir, "HLA.females.auto.iids.txt", sep = ""), sep = "\t", header = FALSE, stringsAsFactors = FALSE)
  auto_grm_ids_males <- read.table(paste(filter_dir, "HLA.males.auto.iids.txt", sep = ""), sep = "\t", header = FALSE, stringsAsFactors = FALSE)
  #Filter pheno_files
