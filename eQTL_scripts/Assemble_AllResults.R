...
# Purpose: Grab and write out the top result line from the topRes files in the gemma dir. Use after AllResultPull.R.
#
...
f_top <- file.path(dir_gemma, paste0("allRes-", method, ".txt"))
...
file_list <- list.files(pattern="\\.allRes.txt$")
message("Pull allRes result")
