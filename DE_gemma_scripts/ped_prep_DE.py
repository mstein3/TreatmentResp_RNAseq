...
grm_id_path = "C:/Users/Mitch V/Documents/UChicago/Research/Sex-specific/filters/males.X.iids.txt"
...
def ped_prep(pheno_loc, grm_id_path, ped_path, map_path):
...
ped_prep(sys.argv[1], sys.argv[2], sys.argv[3], sys.argv[4])