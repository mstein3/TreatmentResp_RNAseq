...
# Usage: Usage: Gemma_bimbam_DE.R <counts> <covar_file> <relat> <geno_file> <gene_name> <dir_pheno> <dir_gemma> 
...
nl_int_subdir <- paste0("Treat_Main", "/")
